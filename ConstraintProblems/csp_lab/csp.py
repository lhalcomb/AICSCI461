...
class CSPState:
    ...
    def copy(self):
        ...
        new_variable_map = {}
        for var_name, variable in list(self.variable_map.items()):
    ...
    def get_constraints_by_name(self, variable_name):
        ...
        """
        constraints = []
        for key, val in list(self.constraint_map.items()):
            v_i, v_j = key
    ...
    def is_solution(self):
        ...
        have an assignment
        """
        for var in list(self.variable_map.values()):
...
if __name__ == "__main__":
    ...
    #import lab4 
    #fc_checker = csp_lab.forward_checking    
    #fcps_checker = csp_lab.forward_checking_prop_singleton
